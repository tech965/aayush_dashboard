...
export enum ConsumptionHistoryGranularity {
  Hourly = 'hourly',
  Daily = 'daily',
  Monthly = 'monthly',
}
...
export enum ProjectAuditLogLevel {
  Base = 'base',
  Extended = 'extended',
  Full = 'full',
}
...
export enum UserDeletionConditionName {
  ProjectCount = 'project_count',
  OrgAdminMembershipCount = 'org_admin_membership_count',
  SubscriptionType = 'subscription_type',
}

export enum OrgDeletionConditionName {
  ProjectCount = 'project_count',
}
...
export enum NeonAuthSupportedAuthProvider {
  Mock = 'mock',
  Stack = 'stack',
  StackV2 = 'stack_v2',
...
export enum NeonAuthProviderProjectOwnedBy {
  User = 'user',
  Neon = 'neon',
}

export enum NeonAuthProviderProjectTransferStatus {
  Initiated = 'initiated',
  Finished = 'finished',
}
...
export enum NeonAuthOauthProviderId {
  Google = 'google',
  Github = 'github',
  Microsoft = 'microsoft',
  Vercel = 'vercel',
...
export enum NeonAuthOauthProviderType {
  Standard = 'standard',
  Shared = 'shared',
}
...
export type NeonAuthEmailServerConfig = BaseNeonAuthEmailServerConfig &
  (
    | BaseNeonAuthEmailServerConfigTypeMapping<'standard', StandardEmailServer>
    | BaseNeonAuthEmailServerConfigTypeMapping<'shared', SharedEmailServer>
  );
 ...
 */
export enum NeonAuthEmailVerificationMethod {
  Link = 'link',
  Otp = 'otp',
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  listProjects = (query: ListProjectsParams, params: RequestParams = {}) =>
    this.request<
      ProjectsResponse & PaginationResponse & ProjectsApplicationsMapResponse & ProjectsIntegrationsMapResponse,
      GeneralError
    >({
      path: `/projects`,
      method: 'GET',
   ...
   * @secure
   */
  restoreProject = (projectId: string, params: RequestParams = {}) =>
    this.request<ProjectRecoverResponse, GeneralError>({
  ...
  recoverProject = (projectId: string, params: RequestParams = {}) =>
    this.request<ProjectRecoverResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/recover`,
      method: 'POST',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  getAvailablePreloadLibraries = (projectId: string, params: RequestParams = {}) =>
    this.request<AvailablePreloadLibraries, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/available_preload_libraries`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  createProjectTransferRequest = (
    ...
    this.request<ProjectTransferRequestResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/transfer_requests`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
  ...
  acceptProjectTransferRequest = (
    ...
    this.request<void, AcceptProjectTransferRequestSatisfiesPlanError | GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/transfer_requests/${encodeURIComponent(requestId)}`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  getProjectJwks = (projectId: string, params: RequestParams = {}) =>
    this.request<ProjectJWKSResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/jwks`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  addProjectJwks = (projectId: string, data: AddProjectJWKSRequest, params: RequestParams = {}) =>
    this.request<JWKSCreationOperation, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/jwks`,
      method: 'POST',
      body: data,
      secure: true,
   ...
   * @secure
   */
  deleteProjectJwks = (projectId: string, jwksId: string, params: RequestParams = {}) =>
    this.request<JWKS, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/jwks/${encodeURIComponent(jwksId)}`,
      method: 'DELETE',
      secure: true,
      format: 'json',
      ...params,
  ...
  createProjectBranchDataApi = (
    ...
    branchId: string,
    databaseName: string,
    data: DataAPICreateRequest,
    params: RequestParams = {},
  ) =>
    this.request<DataAPICreateResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/data-api/${encodeURIComponent(databaseName)}`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
  ...
  updateProjectBranchDataApi = (
    ...
    branchId: string,
    databaseName: string,
    data: DataAPIUpdateRequest,
    params: RequestParams = {},
  ) =>
    this.request<EmptyResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/data-api/${encodeURIComponent(databaseName)}`,
      method: 'PATCH',
      body: data,
      secure: true,
   ...
   * @secure
   */
  getProjectBranchDataApi = (projectId: string, branchId: string, databaseName: string, params: RequestParams = {}) =>
    this.request<DataAPIReponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/data-api/${encodeURIComponent(databaseName)}`,
      method: 'GET',
      secure: true,
      format: 'json',
   ...
   * @secure
   */
  createNeonAuthIntegration = (data: NeonAuthCreateIntegrationRequest, params: RequestParams = {}) =>
    this.request<NeonAuthCreateIntegrationResponse, GeneralError>({
   ...
   * @secure
   */
  getNeonAuth = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<NeonAuthIntegration, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  disableNeonAuth = (
    ...
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth`,
      method: 'DELETE',
      body: data,
      secure: true,
   ...
   * @secure
   */
  listNeonAuthRedirectUriWhitelistDomains = (projectId: string, params: RequestParams = {}) =>
    this.request<NeonAuthRedirectURIWhitelistResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/domains`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  addNeonAuthDomainToRedirectUriWhitelist = (
    projectId: string,
    data: NeonAuthAddDomainToRedirectURIWhitelistRequest,
    params: RequestParams = {},
  ) =>
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/domains`,
  ...
  deleteNeonAuthDomainFromRedirectUriWhitelist = (
    projectId: string,
    data: NeonAuthDeleteDomainFromRedirectURIWhitelistRequest,
    params: RequestParams = {},
  ) =>
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/domains`,
   ...
   * @secure
   */
  listBranchNeonAuthTrustedDomains = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<NeonAuthRedirectURIWhitelistResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/domains`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  createNeonAuthProviderSdkKeys = (data: NeonAuthCreateAuthProviderSDKKeysRequest, params: RequestParams = {}) =>
    this.request<NeonAuthCreateIntegrationResponse, GeneralError>({
   ...
   * @secure
   */
  createNeonAuthNewUser = (data: NeonAuthCreateNewUserRequest, params: RequestParams = {}) =>
    this.request<NeonAuthCreateNewUserResponse, GeneralError>({
  ...
  createBranchNeonAuthNewUser = (
    projectId: string,
    branchId: string,
    data: CreateBranchNeonAuthNewUserRequest,
    params: RequestParams = {},
  ) =>
    this.request<NeonAuthCreateNewUserResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/users`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  deleteBranchNeonAuthUser = (projectId: string, branchId: string, authUserId: string, params: RequestParams = {}) =>
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/users/${encodeURIComponent(authUserId)}`,
      method: 'DELETE',
      secure: true,
      ...params,
    });
  ...
  updateNeonAuthUserRole = (
    ...
    branchId: string,
    authUserId: string,
    data: UpdateNeonAuthUserRoleRequest,
    params: RequestParams = {},
  ) =>
    this.request<UpdateNeonAuthUserRoleResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/users/${encodeURIComponent(authUserId)}/role`,
      method: 'PUT',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  deleteNeonAuthUser = (projectId: string, authUserId: string, params: RequestParams = {}) =>
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/users/${encodeURIComponent(authUserId)}`,
      method: 'DELETE',
      secure: true,
      ...params,
    });
   ...
   * @secure
   */
  transferNeonAuthProviderProject = (data: NeonAuthTransferAuthProviderProjectRequest, params: RequestParams = {}) =>
    this.request<NeonAuthTransferAuthProviderProjectResponse, GeneralError>({
   ...
   * @secure
   */
  listNeonAuthIntegrations = (projectId: string, params: RequestParams = {}) =>
    this.request<ListNeonAuthIntegrationsResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/integrations`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  listNeonAuthOauthProviders = (projectId: string, params: RequestParams = {}) =>
    this.request<ListNeonAuthOauthProvidersResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/oauth_providers`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  addNeonAuthOauthProvider = (projectId: string, data: NeonAuthAddOAuthProviderRequest, params: RequestParams = {}) =>
    this.request<NeonAuthOauthProvider, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/oauth_providers`,
      method: 'POST',
      body: data,
      secure: true,
   ...
   * @secure
   */
  listBranchNeonAuthOauthProviders = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<ListNeonAuthOauthProvidersResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/oauth_providers`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  addBranchNeonAuthOauthProvider = (
    projectId: string,
    branchId: string,
    data: NeonAuthAddOAuthProviderRequest,
    params: RequestParams = {},
  ) =>
    this.request<NeonAuthOauthProvider, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/oauth_providers`,
  ...
  updateNeonAuthOauthProvider = (
    ...
    data: NeonAuthUpdateOAuthProviderRequest,
    params: RequestParams = {},
  ) =>
    this.request<NeonAuthOauthProvider, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/oauth_providers/${encodeURIComponent(oauthProviderId)}`,
      method: 'PATCH',
      body: data,
      secure: true,
      type: ContentType.Json,
  ...
  updateBranchNeonAuthOauthProvider = (
    ...
    this.request<NeonAuthOauthProvider, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/oauth_providers/${encodeURIComponent(oauthProviderId)}`,
      method: 'PATCH',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  getNeonAuthEmailServer = (projectId: string, params: RequestParams = {}) =>
    this.request<NeonAuthEmailServerConfig, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/email_server`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  updateNeonAuthEmailServer = (projectId: string, data: NeonAuthEmailServerConfig, params: RequestParams = {}) =>
    this.request<NeonAuthEmailServerConfig, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/email_server`,
      method: 'PATCH',
      body: data,
  ...
  sendNeonAuthTestEmail = (
    projectId: string,
    branchId: string,
    data: SendNeonAuthTestEmailRequest,
    params: RequestParams = {},
  ) =>
    this.request<SendNeonAuthTestEmailResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/send_test_email`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  getNeonAuthEmailAndPasswordConfig = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<NeonAuthEmailAndPasswordConfig, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/email_and_password`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  getNeonAuthEmailProvider = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<NeonAuthEmailServerConfig, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/email_provider`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  deleteNeonAuthIntegration = (
    ...
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/auth/integration/${encodeURIComponent(authProvider)}`,
      method: 'DELETE',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  getNeonAuthAllowLocalhost = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<NeonAuthAllowLocalhostResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/allow_localhost`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  updateNeonAuthAllowLocalhost = (
    projectId: string,
    branchId: string,
    data: UpdateNeonAuthAllowLocalhostRequest,
    params: RequestParams = {},
  ) =>
    this.request<NeonAuthAllowLocalhostResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/auth/allow_localhost`,
  ...
  createProjectBranch = (
    projectId: string,
    data?: BranchCreateRequest & AnnotationCreateValueRequest,
    params: RequestParams = {},
  ) =>
    this.request<
      BranchResponse &
   ...
   * @secure
   */
  listProjectBranches = ({ projectId, ...query }: ListProjectBranchesParams, params: RequestParams = {}) =>
    this.request<BranchesResponse & AnnotationsMapResponse & CursorPaginationResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches`,
      method: 'GET',
      query: query,
      secure: true,
  ...
  createProjectBranchAnonymized = (
    projectId: string,
    data: BranchAnonymizedCreateRequest,
    params: RequestParams = {},
  ) =>
    this.request<
      BranchResponse &
      ...
      GeneralError
    >({
      path: `/projects/${encodeURIComponent(projectId)}/branch_anonymized`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  countProjectBranches = ({ projectId, ...query }: CountProjectBranchesParams, params: RequestParams = {}) =>
    this.request<BranchesCountResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/count`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
  ...
  getProjectBranch = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<BranchResponse & AnnotationResponse, GeneralError>({
  ...
  getProjectBranchSchema = (
    { projectId, branchId, ...query }: GetProjectBranchSchemaParams,
    params: RequestParams = {},
  ) =>
    this.request<BranchSchemaResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/schema`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
  ...
  getProjectBranchSchemaComparison = (
    { projectId, branchId, ...query }: GetProjectBranchSchemaComparisonParams,
    params: RequestParams = {},
  ) =>
    this.request<BranchSchemaCompareResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/compare_schema`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @secure
   */
  getMaskingRules = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<MaskingRulesResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/masking_rules`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  updateMaskingRules = (
    projectId: string,
    branchId: string,
    data: MaskingRulesUpdateRequest,
    params: RequestParams = {},
  ) =>
    this.request<MaskingRulesResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/masking_rules`,
   ...
   * @secure
   */
  getAnonymizedBranchStatus = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<AnonymizedBranchStatusResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/anonymized_status`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  startAnonymization = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<AnonymizedBranchStatusResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/anonymize`,
      method: 'POST',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  setDefaultProjectBranch = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<BranchOperations, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/set_as_default`,
      method: 'POST',
      secure: true,
      format: 'json',
      ...params,
  ...
  finalizeRestoreBranch = (
    ...
    this.request<OperationsResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/finalize_restore`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
  ...
  getProjectBranchRole = (projectId: string, branchId: string, roleName: string, params: RequestParams = {}) =>
    this.request<RoleResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/roles/${encodeURIComponent(roleName)}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  getProjectBranchRolePassword = (projectId: string, branchId: string, roleName: string, params: RequestParams = {}) =>
    this.request<RolePasswordResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/roles/${encodeURIComponent(roleName)}/reveal_password`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  resetProjectBranchRolePassword = (
    ...
    this.request<RoleOperations, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/roles/${encodeURIComponent(roleName)}/reset_password`,
      method: 'POST',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  listProjectVpcEndpoints = (projectId: string, params: RequestParams = {}) =>
    this.request<VPCEndpointsResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/vpc_endpoints`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  assignProjectVpcEndpoint = (
    ...
    data: VPCEndpointAssignment,
    params: RequestParams = {},
  ) =>
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/vpc_endpoints/${encodeURIComponent(vpcEndpointId)}`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  deleteProjectVpcEndpoint = (projectId: string, vpcEndpointId: string, params: RequestParams = {}) =>
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/vpc_endpoints/${encodeURIComponent(vpcEndpointId)}`,
      method: 'DELETE',
      secure: true,
   ...
   * @secure
   */
  restartProjectEndpoint = (projectId: string, endpointId: string, params: RequestParams = {}) =>
    this.request<EndpointOperations, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/endpoints/${encodeURIComponent(endpointId)}/restart`,
      method: 'POST',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  getConsumptionHistoryPerAccount = (query: GetConsumptionHistoryPerAccountParams, params: RequestParams = {}) =>
    this.request<ConsumptionHistoryPerAccountResponse, GeneralError>({
   ...
   * @secure
   */
  getConsumptionHistoryPerProject = (query: GetConsumptionHistoryPerProjectParams, params: RequestParams = {}) =>
    this.request<ConsumptionHistoryPerProjectResponse & PaginationResponse, GeneralError>({
  ...
  getOrganization = (orgId: string, params: RequestParams = {}) =>
    this.request<Organization, GeneralError>({
   ...
   * @secure
   */
  listOrgApiKeys = (orgId: string, params: RequestParams = {}) =>
    this.request<OrgApiKeysListResponseItem[], GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/api_keys`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  createOrgApiKey = (orgId: string, data: OrgApiKeyCreateRequest, params: RequestParams = {}) =>
    this.request<OrgApiKeyCreateResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/api_keys`,
      method: 'POST',
      body: data,
      secure: true,
   ...
   * @secure
   */
  revokeOrgApiKey = (orgId: string, keyId: number, params: RequestParams = {}) =>
    this.request<OrgApiKeyRevokeResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/api_keys/${encodeURIComponent(keyId)}`,
      method: 'DELETE',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  getOrganizationMembers = (orgId: string, params: RequestParams = {}) =>
    this.request<OrganizationMembersResponse, GeneralError>({
   ...
   * @secure
   */
  getOrganizationMember = (orgId: string, memberId: string, params: RequestParams = {}) =>
    this.request<Member, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/members/${encodeURIComponent(memberId)}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  removeOrganizationMember = (orgId: string, memberId: string, params: RequestParams = {}) =>
    this.request<EmptyResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/members/${encodeURIComponent(memberId)}`,
      method: 'DELETE',
      secure: true,
   ...
   * @secure
   */
  getOrganizationInvitations = (orgId: string, params: RequestParams = {}) =>
    this.request<OrganizationInvitationsResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/invitations`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  createOrganizationInvitations = (orgId: string, data: OrganizationInvitesCreateRequest, params: RequestParams = {}) =>
    this.request<OrganizationInvitationsResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/invitations`,
      method: 'POST',
      body: data,
  ...
  transferProjectsFromOrgToOrg = (
    sourceOrgId: string,
    data: TransferProjectsToOrganizationRequest,
    params: RequestParams = {},
  ) =>
    this.request<EmptyResponse, LimitsUnsatisfiedResponse | ProjectsWithIntegrationResponse | GeneralError>({
      path: `/organizations/${encodeURIComponent(sourceOrgId)}/projects/transfer`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  listOrganizationVpcEndpointsAllRegions = (orgId: string, params: RequestParams = {}) =>
    this.request<VPCEndpointsWithRegionResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/vpc/vpc_endpoints`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  listOrganizationVpcEndpoints = (orgId: string, regionId: string, params: RequestParams = {}) =>
    this.request<VPCEndpointsResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/vpc/region/${encodeURIComponent(regionId)}/vpc_endpoints`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  getOrganizationVpcEndpointDetails = (
    ...
    this.request<VPCEndpointDetails, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/vpc/region/${encodeURIComponent(regionId)}/vpc_endpoints/${encodeURIComponent(vpcEndpointId)}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  getActiveRegions = (params: RequestParams = {}) =>
    this.request<ActiveRegionsResponse, GeneralError>({
      path: `/regions`,
      method: 'GET',
      secure: true,
      format: 'json',
  ...
  getCurrentUserOrganizations = (params: RequestParams = {}) =>
    this.request<OrganizationsResponse, GeneralError>({
   ...
   * @secure
   */
  transferProjectsFromUserToOrg = (data: TransferProjectsToOrganizationRequest, params: RequestParams = {}) =>
    this.request<EmptyResponse, LimitsUnsatisfiedResponse | ProjectsWithIntegrationResponse | GeneralError>({
   ...
   * @secure
   */
  getAuthDetails = (params: RequestParams = {}) =>
    this.request<AuthDetailsResponse, GeneralError>({
      path: `/auth`,
      method: 'GET',
      secure: true,
      format: 'json',
   ...
   * @secure
   */
  createSnapshot = ({ projectId, branchId, ...query }: CreateSnapshotParams, params: RequestParams = {}) =>
    this.request<
      {
        snapshot: Snapshot;
        operations: Operation[];
      ...
      GeneralError
    >({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/snapshot`,
      method: 'POST',
      query: query,
      secure: true,
      format: 'json',
   ...
   * @secure
   */
  listSnapshots = (projectId: string, params: RequestParams = {}) =>
    this.request<
      {
        snapshots: Snapshot[];
      },
      GeneralError
    >({
      path: `/projects/${encodeURIComponent(projectId)}/snapshots`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  deleteSnapshot = (projectId: string, snapshotId: string, params: RequestParams = {}) =>
    this.request<OperationsResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/snapshots/${encodeURIComponent(snapshotId)}`,
      method: 'DELETE',
      secure: true,
      format: 'json',
      ...params,
   ...
   * @secure
   */
  updateSnapshot = (projectId: string, snapshotId: string, data: SnapshotUpdateRequest, params: RequestParams = {}) =>
    this.request<
      {
        snapshot: Snapshot;
      },
   ...
   */
  restoreSnapshot = (
    { projectId, snapshotId, ...query }: RestoreSnapshotParams,
    data?: {
      /**
    ...
    this.request<BranchResponse & EndpointsOptionalResponse & OperationsResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/snapshots/${encodeURIComponent(snapshotId)}/restore`,
      method: 'POST',
      query: query,
      body: data,
      secure: true,
   ...
   * @secure
   */
  getSnapshotSchedule = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<BackupSchedule, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/backup_schedule`,
      method: 'GET',
      secure: true,
      ...params,
    });
   ...
   * @secure
   */
  setSnapshotSchedule = (projectId: string, branchId: string, data: BackupSchedule, params: RequestParams = {}) =>
    this.request<EmptyResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/backup_schedule`,
      method: 'PUT',
      body: data,
