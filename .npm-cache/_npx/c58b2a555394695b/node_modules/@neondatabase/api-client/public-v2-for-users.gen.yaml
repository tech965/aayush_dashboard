...
tags:
- name: API Key
  description: These methods allow you to create and manage API keys for your 
    Neon account. For related information, see [Manage API 
    keys](https://neon.tech/docs/manage/api-keys).
- name: Operation
  description: These methods allow you to view operation details for your Neon 
    project. For related information, see 
    [Operations](https://neon.tech/docs/manage/operations).
- name: Project
  description: These methods allow you to create and manage Neon projects. For 
    related information, see [Manage 
    projects](https://neon.tech/docs/manage/projects).
- name: Branch
  description: These methods allow you to create and manage branches in your 
    Neon project. For related information, see [Manage 
    branches](https://neon.tech/docs/manage/branches).
- name: Endpoint
  description: These methods allow you to create and manage compute endpoints in
    your Neon project. For related information, see [Manage compute 
    endpoints](https://neon.tech/docs/manage/endpoints).
- name: Snapshot
  description: These methods allow you to create and manage snapshots.
- name: Preview
  description: New API methods that are in a Preview state and may be subject to
    changes.
- name: Region
...
- name: Consumption
  description: These methods allow you to view consumption details for your Neon
    account.
- name: Organizations
...
- name: Auth (legacy)
  description: These methods allow you to create and manage Neon Auth projects. 
    Deprecated. See routes with the `Auth` tag instead.
paths:
  /api_keys:
    get:
  ...
  /projects:
    get:
      ...
      parameters:
      - name: cursor
        description: Specify the cursor value from the previous response to 
          retrieve the next batch of projects.
        in: query
        schema:
          type: string
      - name: limit
        description: Specify a value from 1 to 400 to limit number of projects 
          in the response.
        in: query
        schema:
          type: integer
          ...
          maximum: 400
      - name: search
        description: Search by project `name` or `id`. You can specify partial 
          `name` or `id` values to filter results.
        in: query
        schema:
          type: string
      - name: org_id
          ...
          content:
            application/json:
              ...
              example:
                ...
                applications:
                  winter-boat-259881: ["vercel", "github"]
                integrations:
                  winter-boat-259881: ["vercel", "github"]
        default:
          $ref: "#/components/responses/GeneralError"
  ...
  /projects/shared:
    get:
      ...
      parameters:
      - name: cursor
        description: Specify the cursor value from the previous response to get 
  ...
  /projects/{project_id}/restore:
    ...
    post:
      ...
      description: |
        DEPRECATED, use `/projects/{project_id}/recover` instead. Restores a deleted project during the deletion grace period.
        You can obtain a `project_id` by listing the projects for your Neon account.

        **Note**: This endpoint is currently in Private Preview.
      tags:
      - Project
  ...
  /projects/{project_id}/operations:
    get:
      ...
      - name: cursor
        description: Specify the cursor value from the previous response to get 
          the next batch of operations
        in: query
        schema:
          type: string
      - name: limit
        description: Specify a value from 1 to 1000 to limit number of 
  ...
  /projects/{project_id}/permissions:
    ...
    get:
      ...
      description: Retrieves details about users who have access to the project,
        including the permission `id`, the granted-to email address, and the 
        date project access was granted.
      tags:
      - Project
    ...
    post:
      ...
      description: Grants project access to the account associated with the 
  ...
  /projects/{project_id}/permissions/{permission_id}:
    ...
    delete:
      ...
      description: Revokes project access from the user associated with the 
        specified permission `id`. You can retrieve a user's permission `id` by 
  ...
  /projects/{project_id}/transfer_requests/{request_id}:
    ...
    put:
      ...
      responses:
        ...
        406:
          description: Account doesn't satisfy the plan requirements to own the 
            project
          content:
            application/json:
              schema:
  ...
  /projects/{project_id}/jwks:
    ...
    post:
      ...
      responses:
        201:
          description: The JWKS URL was added to the project's authentication 
            connections
          content:
            application/json:
              schema:
  ...
  /projects/{project_id}/branches/{branch_id}/data-api/{database_name}:
    ...
    patch:
      ...
      responses:
        201:
          description: Updated the Neon Data API configuration and refreshed the
            schema cache
          content:
            application/json:
              schema:
  ...
  /projects/{project_id}/branches/{branch_id}/auth:
    ...
    get:
      ...
      description: / Fetches the details of the Neon Auth for the specified 
        branch. You can obtain the `project_id` and `branch_id` by listing the 
        projects and branches for your Neon account.
      tags:
      - Auth
      ...
      responses:
        200:
          description: Fetched the details of the Neon Auth integration for the 
            specified branch
          content:
            application/json:
              schema:
          ...
          application/json:
            schema:
              ...
              properties:
                delete_data:
                  type: boolean
                  description: If true, deletes the `neon_auth` schema from the 
                    database
                  default: false
      responses:
        200:
  ...
  /projects/auth/transfer_ownership:
    post:
      ...
      responses:
        200:
          description: Transfer initiated. Follow the URL to complete the 
            process in your auth provider's UI.
          content:
            application/json:
              schema:
  ...
  /projects/{project_id}/auth/integrations:
    get:
      ...
      description: DEPRECATED, use 
        `/projects/{project_id}/branches/{branch_id}/auth` instead.
      tags:
      - Auth (legacy)
  ...
  /projects/{project_id}/branches/{branch_id}/auth/email_and_password:
    ...
    get:
      ...
      responses:
        200:
          description: Returns the email and password configuration for Neon 
            Auth
          content:
            application/json:
              schema:
  ...
  /projects/{project_id}/branches/{branch_id}/auth/email_provider:
    ...
    get:
      ...
      responses:
        200:
          description: Returns the email provider configuration for the Neon 
            Auth
          content:
            application/json:
              schema:
  ...
  /projects/{project_id}/connection_uri:
    get:
      ...
      - name: branch_id
        in: query
        description: The branch ID. Defaults to your project's default 
          `branch_id` if not specified.
        required: false
        schema:
          type: string
          pattern: "^[a-z0-9-]{1,60}$"
      - name: endpoint_id
        in: query
        description: The endpoint ID. Defaults to the read-write `endpoint_id` 
          associated with the `branch_id` if not specified.
        required: false
        schema:
          type: string
          pattern: "^[a-z0-9-]{1,60}$"
      ...
      - name: pooled
        in: query
        description: Adds the `-pooler` option to the connection URI when set to
          `true`, creating a pooled connection URI.
        required: false
        schema:
          type: boolean
      responses:
  ...
  /projects/{project_id}/branches:
    ...
    get:
      ...
      parameters:
      - name: search
        description: Search by branch `name` or `id`. You can specify partial 
          `name` or `id` values to filter results.
        in: query
        schema:
          type: string
      - name: sort_by
        description: Sort the branches by sort_field. If not provided, branches 
          will be sorted by updated_at descending order
        in: query
        schema:
          type: string
          default: updated_at
            ...
            application/json:
              ...
              example:
                ...
                - id: b6afbc21-2990-4a76-980b-b57d8c2948f2
                  ...
                  total_duration_ms: 100
        204:
          description: Returned if the branch doesn't exist or has already been 
            deleted
        default:
          $ref: "#/components/responses/GeneralError"
    patch:
  ...
  /projects/{project_id}/branches/{branch_id}/restore:
    post:
      ...
      description: Restores a branch to an earlier state in its own or another 
        branch's history
  ...
  /projects/{project_id}/branches/{branch_id}/schema:
    get:
      ...
      description: Retrieves the schema from the specified database. The `lsn` 
        and `timestamp` values cannot be specified at the same time. If both are
        omitted, the database schema is retrieved from database's head.
  ...
  /projects/{project_id}/branches/{branch_id}/compare_schema:
    get:
      ...
      description: Compares the schema from the specified database with another 
        branch's schema.
          ...
          application/json:
            schema:
              ...
              properties:
                name:
                  type: string
                  description: used to rename the existing branch when it is 
                    replaced. if omitted, a default name is generated and used
      responses:
        200:
          description: OK
          content:
            ...
            application/json:
              ...
              example:
                ...
                - id: 42dafb46-f861-497b-ae89-f2bec54f4966
                  ...
                  total_duration_ms: 100
        204:
          description: Returned if the database doesn't exist or has already 
            been deleted
        default:
          $ref: "#/components/responses/GeneralError"
            ...
            application/json:
              ...
              example:
                ...
                - id: ab94cdad-7630-4943-a55e-5a0952d2e598
                  ...
                  total_duration_ms: 100
        204:
          description: Returned if the role doesn't exist or has already been 
            deleted
        default:
          $ref: "#/components/responses/GeneralError"
  ...
  /projects/{project_id}/vpc_endpoints:
    ...
    get:
      ...
      responses:
        200:
          description: Returned VPC endpoint restrictions for the specified 
            project
          content:
            application/json:
              schema:
  ...
  /projects/{project_id}/vpc_endpoints/{vpc_endpoint_id}:
    ...
    post:
      ...
      responses:
        200:
          description: Configured the specified VPC endpoint as a restriction 
    ...
    delete:
      ...
      responses:
        200:
          description: Removed the VPC endpoint restriction from the specified 
            Neon project
        default:
          $ref: "#/components/responses/GeneralError"
            ...
            application/json:
              ...
              example:
                ...
                - id: fd11748e-3c68-458f-b9e3-66d409e3eef0
                  ...
                  total_duration_ms: 100
        204:
          description: Returned if the endpoint doesn't exist or has already 
            been deleted
        default:
          $ref: "#/components/responses/GeneralError"
    patch:
  ...
  /consumption_history/account:
    get:
      ...
      responses:
        ...
        403:
          description: This endpoint is not available. It is only supported for 
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/GeneralError"
        404:
          description: Account is not a member of the organization specified by 
            `org_id`.
          content:
            application/json:
              schema:
    ...
    get:
      ...
      - name: cursor
        ...
        schema:
          type: string
      - name: limit
        description: Specify a value from 1 to 100 to limit number of projects 
          in the response.
        in: query
        schema:
          type: integer
          ...
          content:
            application/json:
              schema:
                ...
                - $ref: "#/components/schemas/PaginationResponse"
        403:
          description: This endpoint is not available. It is only supported with
            Scale, Business, and Enterprise plan accounts.
          content:
            application/json:
              schema:
  ...
  /organizations/{source_org_id}/projects/transfer:
    ...
    - name: source_org_id
      in: path
      description: The Neon organization ID (source org, which currently owns 
        the project)
      required: true
      schema:
        type: string
    ...
    post:
      ...
      responses:
        200:
          description: Projects successfully transferred from organization to 
            organization
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/EmptyResponse"
        406:
          description: Transfer failed - the target organization has too many 
            projects or its plan is incompatible with the source organization. 
            Reduce projects or upgrade the organization.
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/LimitsUnsatisfiedResponse"
        422:
          description: One or more of the provided project IDs have GitHub or 
            Vercel integrations installed. Transferring integration projects is 
  ...
  /organizations/{org_id}/vpc/vpc_endpoints:
    ...
    get:
      ...
      responses:
        200:
          description: The list of configured VPC endpoint IDs for the specified
  ...
  /organizations/{org_id}/vpc/region/{region_id}/vpc_endpoints/{vpc_endpoint_id}:
    ...
    get:
      ...
      responses:
        200:
          description: Returned the current status and configuration details of 
            the specified VPC endpoint.
          content:
            application/json:
              schema:
    ...
    post:
      ...
      responses:
        200:
          description: Assigned the VPC endpoint to the specified Neon 
            organization
        default:
          $ref: "#/components/responses/GeneralError"
    delete:
      ...
      responses:
        200:
          description: Deleted the VPC endpoint from the specified Neon 
            organization
        default:
          $ref: "#/components/responses/GeneralError"
  /regions:
  ...
  /users/me/projects/transfer:
    post:
      ...
      responses:
        200:
          description: Projects successfully transferred from personal account 
            to organization
          content:
            application/json:
              schema:
        ...
        406:
          description: Transfer failed - the target organization has too many 
            projects or its plan is incompatible with the source account. Reduce
            the number of projects or upgrade the target organization to 
...
components:
      ...
      content:
        application/json:
          schema:
            ...
            - $ref: "#/components/schemas/EndpointsResponse"
    CreatedBranch:
      description: Created a branch. An endpoint is only created if it was 
  ...
  schemas:
    ...
    AddProjectJWKSRequest:
      ...
      properties:
        jwks_url:
          ...
          type: string
        provider_name:
          description: The name of the authentication provider (e.g., Clerk, 
            Stytch, Auth0)
          type: string
        branch_id:
        ...
        role_names:
          type: array
          description: DEPRECATED. This field should only be used when using 
            Neon RLS. The roles the JWKS should be mapped to. By default, the 
            JWKS is mapped to the `authenticator`, `authenticated` and 
            `anonymous` roles.
          deprecated: true
          minItems: 0
          maxItems: 10
        ...
        skip_role_creation:
          type: boolean
          description: DEPRECATED. This field should only be used when using 
            Neon RLS. If true, the role creation will be skipped.
          default: false
    JWKS:
      type: object
      required:
    ...
    ApiKeyCreateRequest:
      ...
      properties:
        key_name:
          type: string
          description: A user-specified API key name. This value is required 
    ...
    ApiKeyCreateResponse:
      ...
      properties:
        id:
          ...
          format: int64
        key:
          description: The generated 64-bit token required to access the Neon 
            API
          type: string
        name:
    ...
    ApiKeyRevokeResponse:
      ...
      properties:
        ...
        last_used_from_addr:
          ...
          type: string
        revoked:
          description: A `true` or `false` value indicating whether the API key 
            is revoked
          type: boolean
    ...
    Operation:
      ...
      properties:
        ...
        failures_count:
          ...
          format: int32
        retry_at:
          description: A timestamp indicating when the operation was last 
            retried
          type: string
          format: date-time
        created_at:
          ...
          format: date-time
        updated_at:
          description: A timestamp indicating when the operation status was last
            updated
          type: string
          format: date-time
        total_duration_ms:
    ...
    ProjectListItem:
      ...
      properties:
        ...
        history_retention_seconds: &history_retention_seconds
          ...
          format: int32
        hipaa_enabled_at:
          description: A timestamp indicating when HIPAA was enabled for this 
            project
          type: string
          format: date-time
        deleted_at:
          ...
          format: date-time
        recoverable_until:
          description: A timestamp indicating the project will be recoverable 
        ...
        project:
          ...
          properties:
            settings:
              $ref: "#/components/schemas/ProjectSettingsData"
            name:
              description: The project name. If not specified, the name will be 
                identical to the generated project ID
              type: string
              minLength: 1
              maxLength: 256
            branch:
    ...
    AnonymizationRunMetadata:
      type: object
      description: Metadata about the most recent anonymization attempt for the 
        branch.
      properties:
        started_at:
          description: |
    ...
    AllowedIps:
      ...
      properties:
        ips:
          description: A list of IP addresses that are allowed to connect to the
            endpoint.
          type: array
          items:
            type: string
        protected_branches_only:
          description: If true, the list will be applied only to protected 
            branches.
          type: boolean
    MaintenanceWindow:
      description: |
    ...
    BillingAccount:
      ...
      properties:
        ...
        quota_reset_at_last:
          ...
          format: date-time
        name:
          description: The full name of the individual or entity that owns the 
            billing account. This name appears on invoices.
          type: string
        email:
          description: |
      ...
      properties:
        ...
        project_ids:
          ...
          items:
            type: string
            pattern: "^[a-z0-9-]{1,60}$"
          description: The list of projects ids to transfer. Maximum of 400 
            project ids
    ...
    PgbouncerSettingsData:
      ...
      additionalProperties:
        type: string
    PgVersion:
      description: The major Postgres version number. Currently supported 
        versions are `14`, `15`, `16`, `17`, and `18`.
      type: integer
      minimum: 14
      maximum: 18
      default: 17
    ...
    DataAPISettings:
      ...
      properties:
        ...
        db_max_rows:
          type: integer
          description: Maximum number of rows that can be returned in a single 
            request
        db_schemas:
          type: array
          items:
    ...
    DataAPICreateRequest:
      ...
      properties:
        ...
        jwt_audience:
          ...
          type: string
        add_default_grants:
          description: Grant all permissions to the tables in the public schema 
    ...
    NeonAuthEmailAndPasswordConfig:
      ...
      properties:
        ...
        require_email_verification:
          type: boolean
          description: Whether email verification is required before users can 
            sign in
        auto_sign_in_after_verification:
          type: boolean
          description: Whether users are automatically signed in after verifying
            their email
        send_verification_email_on_sign_up:
          type: boolean
    ...
    ProjectsApplicationsMapResponse:
      ...
      example: {"applications": {"winter-boat-259881": ["vercel", "github", "datadog",
            "opentelemetry"]}}
      ...
      properties:
        integrations:
          ...
          additionalProperties:
            ...
            items:
              $ref: "#/components/schemas/ApplicationType"
      example: {"integrations": {"winter-boat-259881": ["vercel", "github", "datadog",
            "opentelemetry"]}}
    ...
    CursorPagination:
      type: object
      description: To paginate the response, issue an initial request with 
        `limit` value. Then, add the value returned in the response 
        `.pagination.next` attribute into the request under the `cursor` query 
        parameter to the subsequent request to retrieve next page in pagination.
        The contents on cursor `next` are opaque, clients are not expected to 
        make any assumptions on the format of the data inside the cursor.
      properties:
        next:
          type: string
        sort_by:
  ...
  parameters:
    CursorParam:
      name: cursor
      description: A cursor to use in pagination. A cursor defines your place in
        the data list. Include `response.pagination.next` in subsequent API 
        calls to fetch next page of the list.
      in: query
      schema:
        type: string
    LimitParam:
